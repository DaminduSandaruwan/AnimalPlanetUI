...
class Strings{
  ...
  static const String READY_TO_WATCH_DESC = "A planet is a global leader in real life entertainment, serving a passionate audience of superfans around the world with content that inspires, informs and entertain.";
  static const String START_ENJOYING = "Start Enjoying";
  static const String LAST_STEP_TO_ENJOY = "Last step to enjoy";
  static const String CHOOSE_A_PLAN = "Choose a Plan";
  static const String WEEK_SUBSCRIPTION = "Week subscription";
  static const String ONE_MONTH_SUBSCRIPTION = "1 Month subscription";
